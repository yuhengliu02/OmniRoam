...
class BaseModel(nn.Module):
    ...
    def _initialize_models(self, args, device):
        ...
        if use_custom_teacher:
            ...
            teacher_ckpt_path = getattr(args, "teacher_ckpt_path", None)
            base_wan_path = getattr(args, "base_wan_path", "wan_models/Wan2.1-T2V-1.3B/")
            ...
            self.real_score = CustomTeacherWrapper(
                ...
                torch_dtype=torch.bfloat16 if args.mixed_precision else torch.float32,
                device=device,
                model_name="Teacher"
            )
            ...
            print("[BaseModel] Using vanilla WAN2.1 teacher (real_score)")
    ...
    def _consistency_backward_simulation(
        ...
        **conditional_dict: dict
        ...
        Input:
            ...
            - conditional_dict: a dictionary containing the conditional information (e.g. text embeddings, image embeddings).
                May also contain cam_traj and speed_scalar for custom teacher.
        Output:
